...
namespace gameanalytics {
    extern "C"
    {
        ...
        extern void jni_addAdEventWithReason(int action, int adType, const char *adSdkName, const char *adPlacement, int noAdReason, const char *fields, bool mergeFields);
